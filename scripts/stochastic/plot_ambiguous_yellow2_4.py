...
run_numberV = [2, 4, 5, 6] # run 2 and runs >= 4 have the more stringent tlimit = 100,000
...
# Create the figure
plt.legend(handles=legend_elements, loc='lower right', framealpha=1, fontsize='small')

# plt.show()

fname = dir_results + 'ambiguous_yellow2_4.pdf'
plt.tight_layout()
plt.savefig(fname)
plt.close()
