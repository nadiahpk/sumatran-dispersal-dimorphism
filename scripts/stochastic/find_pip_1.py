...
# NOTE I am using a fairly lax standard for equilibriation of the invader dynamics
...
params = {
        ...
        'tol_mut': 1e-6,       # the euclidean distance in final mutant structure before say it's equilibriated
